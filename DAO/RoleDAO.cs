...
namespace DAO
{
    public class RoleDAO
    {
        ...
        public DataTable selectAllRole()
        {
            ...
            {
                conn.Open();
                String sql = "select id, role_Name, role_Description from role where isDeleted = 0";
        ...
        public DataTable searchRole(String keyword)
        {
            ...
            {
                conn.Open();
                String sql = "select id, role_Name, role_Description from role where role_name LIKE  '%" + keyword + "%' and isDeleted = 0";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                MySqlDataAdapter returnVal = new MySqlDataAdapter(sql, conn);
        ...
        public DataTable get_Role_From_Id(String id)
        {
            ...
            {
                conn.Open();
                String sql = "select id, role_Name, role_Description from role where id = '" + id + "' and isDeleted = 0";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                MySqlDataAdapter returnVal = new MySqlDataAdapter(sql, conn);
                returnVal.Fill(role);
            }
        ...
        public DataTable check_Name(string name, string id)
        {
            ...
            {
                conn.Open();
                String sql = "select id, role_Name, role_Description from role where role_name = '" + name + "' and id not in ('"+ id +"') and isDeleted = 0";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                MySqlDataAdapter returnVal = new MySqlDataAdapter(sql, conn);
